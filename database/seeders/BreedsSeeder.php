...
class BreedsSeeder extends Seeder
{
    private array $breeds = [
        ...
        ["id" => 44, "name" => "Краснопестрая голштинская", "type" => "молочная"],
        ["id" => 45, "name" => "Краснопестрая немецкая", "type" => "молочная"],
        ...
        ["id" => 112, "name" => "Черно-пестрая голштинская", "type" => "молочная"],
        ["id" => 113, "name" => "Шароле", "type" => "мясная"],
        ["id" => 114, "name" => "Шведиш Ред", "type" => "молочно-мясная"],
        ["id" => 115, "name" => "Шортгорнская (мол.)", "type" => "молочная"],
        ["id" => 116, "name" => "Шортгорнская (мясн.)", "type" => "мясная"],
        ["id" => 117, "name" => "Юринская", "type" => "молочно-мясная"],
        ["id" => 118, "name" => "Яки", "type" => "мясная"],
        ["id" => 119, "name" => "Якутский скот", "type" => "молочно-мясная"],
        ["id" => 120, "name" => "Ярославская", "type" => "молочно-мясная"],
    ];

<form action="{{route('animals.update',['animal' => $animal])}}" method="POST" class="row">
    ...
    <div class="col-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control " id="name" value="{{old('name') ?? $animal->name }}" name="name" aria-describedby="name">
        </div>
        <div class="mb-3">
            <label for="number" class="form-label">Number</label>
            <input type="text" class="form-control " id="number" value="{{old('number') ?? $animal->number }}" name="number" aria-describedby="number">
        </div>
        <div class="mb-3">
            <label for="number_collar" class="form-label">Number collar</label>
            <input type="text" class="form-control " id="number_collar" value="{{old('number_collar') ?? $animal->number_collar }}" name="number_collar"
                   aria-describedby="number_collar">
        </div>
        <div class="mb-3">
            <label for="number_rshn" class="form-label">Number rshn</label>
            <input type="text" class="form-control " id="number_rshn" value="{{old('number_rshn') ?? $animal->number_rshn }}" name="number_rshn"
                   aria-describedby="number_rshn">
        </div>
        <div class="mb-3">
            <label for="number_rf" class="form-label">Number rf</label>
            <input type="text" class="form-control " id="number_rf" value="{{old('number_rf') ?? $animal->number_rf }}" name="number_rf"
                   aria-describedby="number_rf">
        </div>
        <div class="mb-3">
            <label for="number_tavro" class="form-label">Number tavro</label>
            <input type="text" class="form-control " id="number_tavro" value="{{old('number_tavro') ?? $animal->number_tavro }}" name="number_tavro"
                   aria-describedby="number_tavro">
        </div>
        <div class="mb-3">
            <label for="number_tag" class="form-label">Number tag</label>
            <input type="text" class="form-control " id="number_tag" value="{{old('number_tag') ?? $animal->number_tag }}" name="number_tag"
    ...
    <div class="col-6">
        ...
        <div class="mb-3">
            ...
            <select class="form-select " aria-label="Пример выбора по умолчанию" id="status_id" name="status_id">
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" class="form-control " id="birthday" value="{{old('birthday') ?? $animal->birthday }}" name="birthday"
                   aria-describedby="birthday">
        </div>

        <div class="mb-3">
            <label for="withdrawn_at" class="form-label">Withdrawn at</label>
            <input type="datetime-local" class="form-control " id="withdrawn_at" value="{{old('withdrawn_at') ?? $animal->withdrawn_at }}" name="withdrawn_at"
                   aria-describedby="withdrawn_at">
        </div>

        <div class="mb-3">
            <label for="tag_color" class="form-label">Tag color</label>
            <input type="color" class="form-control  form-control-color" id="tag_color" value="{{old('tag_color') ?? $animal->tag_color }}" name="tag_color"
                   aria-describedby="tag_color">
        </div>
    </div>
    <div class="my-1 border-top pt-2 border-2">
        <button type="submit" class="btn btn-outline-primary">Update</button>
        <a href="{{route('animals.show',['animal' => $animal])}}" class="btn btn-outline-secondary">Show</a>
    </div>
</form>
